...
app.controller('loginCtrl', ['$scope', 'Auth', '$state',
...
app.controller('secureCtrl', ['$scope', 'Auth', '$state',
  function($scope, Auth, $state) {
...
app.controller('UserDetailCtrl', ['$scope', '$stateParams', 'UserFactory', '$location',
