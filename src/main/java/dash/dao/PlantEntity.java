...
public class PlantEntity implements Serializable
{
	...
	@Column(name = "Toxic_Parts")
	private String toxicParts;
	
	@Column(name = "Allergencity")
	...
	public PlantEntity(Long id, String scientificName,
			...
			String companionPlants, String toxicParts, Integer allergencity,
			...
			String touristsSpots, Integer easeOfPlanting,
			String interestingFacts, Date timeToProduce, Integer rootDepth,
			Date duration, Integer pH, Integer price, Integer d4,
			Integer deciduousCover, Integer larval_Butterfly_Host, Integer sap,
			Date seedTiming, Integer seedType, Integer irrigated,
			String cultivarNames, Integer airPurifying, Integer soilPurifying,
			String dataSource, Integer canWeShareTheSource, String tasteOfFruit,
			String website, Integer seedsAndNuts, Integer hoaApproved,
			Integer coldTolerance, Integer droughtTolerance,
			Integer moistureTolerance, String fall, String spring, String summer,
			String winter, String fileStructure) {
		super();
		this.id = id;
